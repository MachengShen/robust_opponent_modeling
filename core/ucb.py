...
def ucb(allocation_size, portfolio, c):
	...
	values = [learner.value for learner in portfolio]  #ms: value is derived from fitness
	#Normalize values
	...
	total_visit = sum(visit_counts)   #ms:here visit_counts are from the begining to the end of training
